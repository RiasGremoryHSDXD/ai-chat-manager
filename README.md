...
- **🔄 Universal Adapter**: Support for Gemini, ChatGPT, Claude, DeepSeek, Perplexity, and HuggingChat.
...
- **🤖 More AI Adapters**: Support for Claude, Perplexity, DeepSeek, and HuggingChat. ✅
